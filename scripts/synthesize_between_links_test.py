"""Guards for the synthesized between (`type 403`) corpus.
...
import pytest
import synthesize_between_links as syn
...
def test_link_decodes_to_a_between_line_constraint(name: str) -> None:
    ...
    assert lines == [{"relation": "between", "path": _PATH}]
