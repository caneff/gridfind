"""Guards for the synthesized renban (`type 400`) corpus.
...
import pytest
import synthesize_renban_links as syn
...
def test_link_decodes_to_a_renban_line_constraint(name: str) -> None:
    ...
    assert lines == [{"relation": "renban", "path": _PATH}]
