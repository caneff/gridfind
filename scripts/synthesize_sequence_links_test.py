"""Guards for the synthesized sequence (`type 405`) corpus.
...
import pytest
import synthesize_sequence_links as syn
...
def test_link_decodes_to_a_sequence_line_constraint(name: str) -> None:
    ...
    assert lines == [{"relation": "sequence", "path": _PATH}]
