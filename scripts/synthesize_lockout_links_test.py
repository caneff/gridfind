"""Guards for the synthesized lockout (`type 407`) corpus.
...
import pytest
import synthesize_lockout_links as syn
...
def test_link_decodes_to_a_lockout_line_constraint(name: str) -> None:
    ...
    assert lines == [{"relation": "lockout", "path": _PATH}]
