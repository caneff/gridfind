...
(renban), `type 401` (whisper), and `type 402` (palindrome) — the first
three rows of the nine-relation family (spec #672), sharing
...
for whisper — renban and palindrome state no extra param), a `disabled`
